...
\begin{equation}
P_{\incl}^{I} = \frac{(N_{\pileup} + 1)!}{n_{1}! \times \dots \times n_{m}!} \cdot p_{1}^{n_{1}} \times \dots \times p_{m}^{n_{m}} \, ,
...
\begin{equation}
P_{j}^{I} = \begin{cases}
\frac{N_{\pileup}!}{n_{1}! \times \dots \times (n_{j} - 1)! \times \dots \times n_{m}!} \cdot p_{1}^{n_{1}} \times \dots \times p_{j}^{(n_{j} - 1)} \times \dots \times p_{m}^{n_{m}} \, ,
  & \text{if $n_{j} \geq 1$} \\
0 \, , & \text{otherwise} \, .
\end{cases}
...
For both triggers and all jet $\pT$ thresholds,
