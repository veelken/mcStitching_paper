...
We will now consider the special case where one MC sample, produced for general physics analyses, covers the whole PS
...
\begin{equation}
w^{i} = \frac{L \, \sigma_{\incl}}{N_{\incl}} \cdot \frac{N_{\incl} \, p_{i}}{N_{\incl} \, p_{i} + \sum_{j} \, N_{j} \, p_{j}^{i}} \, ,
\label{eq:incl}
\end{equation}
...
The two factors in Eq.~(\ref{eq:incl}) have an illustrative interpretation:
...
from $N_{\incl} \, p_{i}$ to $N_{\incl} \, p_{i} + \sum_{j} \, N_{j} \, p_{j}^{i}}$ 
...
$\sqrt{\frac{N_{\incl} \, p_{i}}{N_{\incl} \, p_{i} + \sum_{j} \, N_{j} \, p_{j}^{i}}}$.
