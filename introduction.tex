...
An alternative approach is to divide the PS into distinct regions (``slices'') and to produce separate independent MC samples covering each slice.
...
whereas another set of MC samples may divide the PS based on $\HT$, the scalar sum in $\pT$ of these jets.
