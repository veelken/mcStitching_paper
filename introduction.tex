...
Even if one restricts the production of MC samples to processes with a significantly smaller cross section,
...
The stitching procedure has been used by the ATLAS and CMS experiments since LHC Run $1$,
