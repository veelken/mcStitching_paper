...
The contributions of individual exclusive samples $j$ to the stitched distribution are distinguished by different colors and fill patterns in the upper part of each figure.
The white area represents the contribution of the inclusive sample to the distribution obtained from the stitching procedure.
